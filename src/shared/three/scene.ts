...
export function createScene(app: HTMLElement): SceneContext {
  ...
  // Lights
  scene.add(new THREE.AmbientLight(CONFIG.ambientColor as THREE.ColorRepresentation, CONFIG.ambientIntensity))
  const hemi = new THREE.HemisphereLight(
    CONFIG.hemiSkyColor as THREE.ColorRepresentation,
    CONFIG.hemiGroundColor as THREE.ColorRepresentation,
